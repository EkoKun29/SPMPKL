...
import com.example.spmpkl.databinding.MahasiswaFragmentKirimBinding;
...
public class KirimNilaiFragment extends Fragment {
    EditText file;
    ...
    DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("NilaiMahasiswa");
    FirebaseFirestore db = FirebaseFirestore.getInstance();
    ActivityResultLauncher<String> mData;


    private MahasiswaFragmentKirimBinding binding;

    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {

        binding = MahasiswaFragmentKirimBinding.inflate(inflater, container, false);
        ...
        Select.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (ContextCompat.checkSelfPermission(getActivity().getApplicationContext(), Manifest.permission.READ_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED) {
                    ...
                    ActivityCompat.requestPermissions(KirimNilaiFragment.this.getActivity(), new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, 9);
                }
            }
        });
...
/*
        ...
        storageReference.child("PdfFile").child(fileName).putFile(pdfUri)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Toast.makeText(KirimNilaiFragment.this.getActivity(), "File Upload", Toast.LENGTH_SHORT).show();
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(KirimNilaiFragment.this.getActivity(), "File Not Successfully Uploaded", Toast.LENGTH_SHORT).show();
                    }
                });
    }
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        KirimNilaiFragment.super.onRequestPermissionsResult(requestCode, permissions, grantResults);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if(requestCode==86 && resultCode==RESULT_OK && data!=null){
            ...
            Toast.makeText(KirimNilaiFragment.this.getActivity(), "Please Select a File", Toast.LENGTH_SHORT).show();
        }
    }
